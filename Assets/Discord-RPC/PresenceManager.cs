        ...
        public void ChangeInformation()
        {
            ...
            else
            {
                if (Data_Manager.Instance != null)
                {
                    ...
                    {
                        MapData data = Data_Manager.Instance.GetData()._worldData[FinishLine.Instance.WorldIndex]._mapData[FinishLine.Instance.LevelIndex];
                        instance.presence.details = Data_Manager.Instance.GetData()._worldData[FinishLine.Instance.WorldIndex].WorldName + "  " + data.GetSceneData().MapName;
                        instance.presence.state = "Highscore : " + Timer.FormatTime( data.GetHighScore());
                        instance.presence.largeImageKey = "default";
                        instance.presence.smallImageKey = "default";
                        instance.presence.largeImageText = "ByPass - STUDIO GANG";
                        instance.presence.smallImageText = Data_Manager.Instance.GetData()._worldData[FinishLine.Instance.WorldIndex].WorldName + "  " + data.GetSceneData().MapName;
                    }
                }
            }
